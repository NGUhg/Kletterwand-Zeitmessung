...
int LCD_Port = 1; //An welchem IO die Taster Hängen
...
int Var = 0; // Zum Erleichtern der Änderung
...
void setup()
{
  ...
  lcd.setCursor(0, 0);
  lcd.print("Uhr V 1.3 CND");        // print a simple message
  lcd.setCursor(0, 1);
  lcd.print("(c)Nicolas Grebe");
  Serial.begin(9600);            //Serielle Verbindung Starten
  Serial.println("----------------");
  Serial.println("Uhr V 1.3 CND   ");        // print a simple message
